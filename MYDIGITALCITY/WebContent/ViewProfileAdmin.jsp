     ...
     <div class="vertical-menu"  style="margin-left: 100px; margin-top:0px" >
       ...
       <a href="changepassworda.jsp">CHANGE PASSWORD</a>
        ...
        out.println("<div class='center' align='center' style='margin-top:100px'>"); 
     	  out.println("<table border='1px solid black'><caption>MY PROFILE</caption><tr><th>NAME</th><td>"+rs.getString(4)+"</th></tr>");
     	  out.println("<tr><th>DOB</th><td>"+rs.getDate(6)+"</th></tr>"); 
     	  out.println("<tr><th>CONTACT</th><td>"+rs.getString(5)+"</th></tr>");
     	  out.println("<tr><th>EMAIL</th><td>"+rs.getString(2)+"</th></tr></table></div>");
