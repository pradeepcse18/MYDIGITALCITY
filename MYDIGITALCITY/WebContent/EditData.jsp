...
<html>   
      ...
      while(rs.next()){
     	 ...
     	 out.println("<td style='text-align:center;'><a target='_blank' href='EditByUser.jsp?id="+rs.getString(1)+"'><button style='font-weight: bold; color:green;'><i>EDIT</i></button></td></tr>");
