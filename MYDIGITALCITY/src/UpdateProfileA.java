...
@WebServlet("/UpdateProfileA") 
public class UpdateProfileA extends HttpServlet {
public void doPost(HttpServletRequest request, HttpServletResponse response)
 throws IOException, ServletException
   ...
   PreparedStatement ptmt=con.prepareStatement(" UPDATE ADMINDB SET NAME=? , DOB=?, CONTACT=?, EMAIL=? WHERE EMAIL=?");       
 	...
 	ptmt.setString(5,mail);
 	 ...
 	 int i=ptmt.executeUpdate();
 	  if(i>0){
	      ...
	      out.println("top.window.location ='editadminprofile.jsp'");
	       out.println("</script>");
 	        	}
 	  else {
