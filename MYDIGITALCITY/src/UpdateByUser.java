...
public void doPost(HttpServletRequest request, HttpServletResponse response)
 throws IOException, ServletException
    	...
    	String category=null;
    	 Connection con=DB.getConnection();
    	  ...
    	  ResultSet rs=ptmt1.executeQuery();
    	   ...
    	   PreparedStatement ptmt=con.prepareStatement("INSERT INTO STATEDB ( COUNTRY, STATE, CITY, CATEGORY, NAME, WEBSITE, CONTACT, EMAIL,  ADDRESS , UPLOADBY, OLDID, DOB, STATUS, UACTION) VALUES (?,?,?,?,?,?,?,?,?,?,?,SYSDATE,'F','EDIT')");                               
   ...
   if(i>0) {
      ...
      out.println("top.window.location ='edit.jsp'");
       out.println("</script>");
   }
        	con.close();
        	}
